...
function Footer() {
  return (
    <>
    <div className='flex flex-col md:flex-row p-10 items-center bg-green-300 h-fit'>
    ...
    <div className='flex flex-col w-full flex-1'>
      ...
      <div className='my-10  flex-1 w-full '>
        <h1 className='my-8 text-blue-600 font-bold text-2xl md:text-xl lg:text-2xl'>Quick Links</h1>
      ...
      <div className='my-10 flex-1'>
        <h1 className='my-8 text-blue-600 font-bold text-2xl md:text-xl lg:text-2xl'>Contact</h1>
