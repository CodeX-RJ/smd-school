...
function Footer() {
  return (
    ...
    <div className='flex flex-col md:flex-row px-10 items-center bg-green-300 h-fit'>
      <div className='flex flex-col w-full flex-1'>
          <img src={Schoollogo} alt='school logo' className='w-1/5'></img>
          <h1 className='font-extrabold text-blue-600 text-xl vsm:text-2xl sm:text-3xl  my-4 w-1/2 md:text-2xl lg:text-3xl'>SMT. MAHADEVI PUBLIC HIGHSCHOOL</h1>
          <div className='flex flex-row w-1/5 gap-3 items-center'>
            <img src={youtube} alt='youtube logo' className='w-7 md:w-5 lg:w-7 cursor'></img>
            <img src={facebook} alt='facebook logo' className='w-7 md:w-5 lg:w-7'></img>
            <img src={whatsapp} alt='whatsapp' className='w-7 md:w-5 lg:w-7'></img>
            <img src={email} alt='email' className='w-7 md:w-5 lg:w-7'></img>
          </div>
        </div>
    ...
    <div className='flex flex-col md:flex-row md:gap-10 justify-center items-center my-3'>
      <p className='font-semibold text-sm md:text-md lg:text-lg xl:text-xl'>
        &copy; 2024 Smt. Mahadevi Public Highschool. All rights reserved.
      </p>
