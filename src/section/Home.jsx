...
function Home() {
  return (
    ...
    <div className='flex flex-col gap-2 md:mt-16 p-4'>
        ...
        <h1 className='text-left text-blue-600 font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:7xl my-2'>S. M. D. PUBLIC SCHOOL</h1>
    ...
    <section className='my-20 m-4'>
      <div className='flex flex-col gap-2 sm:flex-row sm:gap-5'>
        <div className='display flex flex-col justify-around py-5 sm:py-15'>
          ...
          <button className='bg-blue-600 px-4 p-1 text-white my-4 hover:text-blue-400 cursor-pointer w-fit lg:text-xl'>Let's Connect</button>
        </div>
